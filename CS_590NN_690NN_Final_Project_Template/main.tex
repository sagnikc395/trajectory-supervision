...
All runs use \texttt{meta-llama/Llama-3.1-8B-Instruct}. We fine-tune with QLoRA using 4-bit NF4 quantization, LoRA rank 32, LoRA alpha 64, bfloat16 computation, maximum sequence length 1024, and an effective batch size of 16. Each block is trained for three epochs. The training runs use seed 42.
...
All three students contributed equally to the project. The shared work included project framing, proposal design, notebook implementation and review, Colab experiment execution and verification, artifact validation, result interpretation, and final report and presentation preparation.
...
\midrule
Vishnu Vardhan Reddy B & Equal contribution to project framing, implementation and review, Colab execution and verification, artifact validation, result interpretation, and final deliverables. \\
Sagnik Chatterjee & Equal contribution to project framing, implementation and review, Colab execution and verification, artifact validation, result interpretation, and final deliverables. \\
Soumik Bhatta & Equal contribution to project framing, implementation and review, Colab execution and verification, artifact validation, result interpretation, and final deliverables. \\
\bottomrule
\end{tabular}
\end{table}
